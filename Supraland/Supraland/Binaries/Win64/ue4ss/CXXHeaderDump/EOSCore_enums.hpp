...
enum class EEOSEAntiCheatClientMode {
    EOS_ACCM_Invalid = 0,
...
enum class EEOSEAntiCheatClientViolationType {
    EOS_ACCVT_Invalid = 0,
...
enum class EEOSEAntiCheatCommonClientAction {
    EOS_ACCCA_Invalid = 0,
    EOS_ACCCA_RemovePlayer = 1,
    EOS_ACCCA_MAX = 2,
};

enum class EEOSEAntiCheatCommonClientActionReason {
...
enum class EEOSEAntiCheatCommonClientAuthStatus {
...
enum class EEOSEAntiCheatCommonClientFlags {
    EOS_ACCCF_None = 0,
    EOS_ACCCF_Admin = 1,
    EOS_ACCCF_MAX = 2,
};

enum class EEOSEAntiCheatCommonClientInput {
    EOS_ACCCI_Unknown = 0,
...
enum class EEOSEAntiCheatCommonClientPlatform {
    EOS_ACCCP_Unknown = 0,
    EOS_ACCCP_Windows = 1,
    EOS_ACCCP_Mac = 2,
    EOS_ACCCP_Linux = 3,
...
enum class EEOSEAntiCheatCommonClientType {
...
enum class EEOSEAntiCheatCommonEventParamType {
...
enum class EEOSEAntiCheatCommonEventType {
    EOS_ACCET_Invalid = 0,
...
enum class EEOSEAntiCheatCommonPlayerMovementState {
    EOS_ACCPMS_None = 0,
...
enum class EEOSEAntiCheatCommonPlayerTakeDamageResult {
    EOS_ACCPTDR_None = 0,
...
enum class EEOSEAntiCheatCommonPlayerTakeDamageSource {
    EOS_ACCPTDS_None = 0,
...
enum class EEOSEAntiCheatCommonPlayerTakeDamageType {
    EOS_ACCPTDT_None = 0,
...
enum class EEOSEConnectionClosedReason {
    EOS_CCR_Unknown = 0,
...
enum class EEOSEExternalAccountType {
    EOS_EAT_EPIC = 0,
    EOS_EAT_STEAM = 1,
    EOS_EAT_PSN = 2,
    EOS_EAT_XBL = 3,
...
enum class EEOSEExternalCredentialType {
    EOS_ECT_EPIC = 0,
...
enum class EEOSELeaderboardAggregation {
    EOS_LA_Min = 0,
    EOS_LA_Max = 1,
    EOS_LA_Sum = 2,
    EOS_LA_Latest = 3,
...
enum class EEOSELinkAccountFlags {
    EOS_LA_NoFlags = 0,
    EOS_LA_NintendoNsaId = 1,
    EOS_LA_MAX = 2,
};

enum class EEOSELobbyAttributeVisibility {
    EOS_LAT_PUBLIC = 0,
    EOS_LAT_PRIVATE = 1,
    EOS_LAT_MAX = 2,
};

enum class EEOSELobbyMemberStatus {
    EOS_LMS_JOINED = 0,
    EOS_LMS_LEFT = 1,
...
enum class EEOSELobbyPermissionLevel {
...
enum class EEOSEMetricsAccountIdType {
    EOS_MAIT_Epic = 0,
    EOS_MAIT_External = 1,
    EOS_MAIT_MAX = 2,
};

enum class EEOSEModEnumerationType {
    EOS_MET_INSTALLED = 0,
    EOS_MET_ALL_AVAILABLE = 1,
    EOS_MET_MAX = 2,
};

enum class EEOSENATType {
    EOS_NAT_Unknown = 0,
    EOS_NAT_Open = 1,
    EOS_NAT_Moderate = 2,
    EOS_NAT_Strict = 3,
...
enum class EEOSEOnlineSessionPermissionLevel {
...
enum class EEOSEOnlineSessionState {
    EOS_OSS_NoSession = 0,
    EOS_OSS_Creating = 1,
    EOS_OSS_Pending = 2,
    EOS_OSS_Starting = 3,
...
enum class EEOSEOwnershipStatus {
    EOS_OS_NotOwned = 0,
    EOS_OS_Owned = 1,
    EOS_OS_MAX = 2,
};

enum class EEOSEPacketReliability {
...
enum class EEOSEPlayerReportsCategory {
    EOS_PRC_Invalid = 0,
    EOS_PRC_Cheating = 1,
...
enum class EEOSERTCAudioInputStatus {
    EOS_RTCAIS_Idle = 0,
...
enum class EEOSERTCAudioOutputStatus {
    EOS_RTCAOS_Idle = 0,
...
enum class EEOSERTCAudioStatus {
...
enum class EEOSERTCParticipantStatus {
    EOS_RTCPS_Joined = 0,
    EOS_RTCPS_Left = 1,
    EOS_RTCPS_MAX = 2,
};

enum class EEOSERelayControl {
    EOS_RC_NoRelays = 0,
...
enum class EEOSESessionAttributeAdvertisementType {
    EOS_SAAT_DontAdvertise = 0,
    EOS_SAAT_Advertise = 1,
    EOS_SAAT_MAX = 2,
};

enum class EEOSEUserControllerType {
    EOS_UCT_Unknown = 0,
...
enum class EEOSLoginCredentialType {
    EOS_LCT_Password = 0,
...
enum class EEOSPlayerDataStorag_EReadResult {
    None = 0,
...
enum class EEOSPlayerDataStorageEWriteResult {
    None = 0,
...
enum class EEOSPresenceEStatus {
    EOS_PS_Offline = 0,
    EOS_PS_Online = 1,
    EOS_PS_Away = 2,
...
enum class EEOSTitleStorageEReadResult {
    NONE = 0,
...
enum class EEOSUIENotificationLocation {
    EOS_UNL_TopLeft = 0,
    EOS_UNL_TopRight = 1,
...
enum class EOSEAuthTokenType {
    EOS_ATT_Client = 0,
    EOS_ATT_User = 1,
    EOS_ATT_MAX = 2,
};

enum class EOSELoginStatus {
    EOS_LS_NotLoggedIn = 0,
    EOS_LS_UsingLocalProfile = 1,
    EOS_LS_LoggedIn = 2,
    EOS_LS_MAX = 3,
