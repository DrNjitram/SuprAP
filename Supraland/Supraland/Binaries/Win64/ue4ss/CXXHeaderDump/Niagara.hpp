...
struct FNiagaraComponentPropertyBinding
{
    ...
    FNiagaraVariable WritableValue;                                                   // 0x0078 (size: 0x20)
...
{
    ENiagaraRibbonUVEdgeMode LeadingEdgeMode;                                         // 0x0000 (size: 0x4)
    ENiagaraRibbonUVEdgeMode TrailingEdgeMode;                                        // 0x0004 (size: 0x4)
    ENiagaraRibbonUVDistributionMode DistributionMode;                                // 0x0008 (size: 0x4)
...
struct FNiagaraVMExecutableData
{
    ...
    TArray<uint8> ScriptLiterals;                                                     // 0x0028 (size: 0x10)
    TArray<FNiagaraVariable> Attributes;                                              // 0x0038 (size: 0x10)
    FNiagaraScriptDataUsageInfo DataUsage;                                            // 0x0048 (size: 0x1)
    TArray<FNiagaraScriptDataInterfaceCompileInfo> DataInterfaceInfo;                 // 0x0050 (size: 0x10)
    TArray<FVMExternalFunctionBindingInfo> CalledVMExternalFunctions;                 // 0x0060 (size: 0x10)
    TArray<FNiagaraDataSetID> ReadDataSets;                                           // 0x0080 (size: 0x10)
    TArray<FNiagaraDataSetProperties> WriteDataSets;                                  // 0x0090 (size: 0x10)
    TArray<FNiagaraStatScope> StatScopes;                                             // 0x00A0 (size: 0x10)
    TArray<FNiagaraDataInterfaceGPUParamInfo> DIParamInfo;                            // 0x00B0 (size: 0x10)
    ENiagaraScriptCompileStatus LastCompileStatus;                                    // 0x00C0 (size: 0x1)
    TArray<FSimulationStageMetaData> SimulationStageMetaData;                         // 0x00C8 (size: 0x10)
    uint8 bReadsSignificanceIndex;                                                    // 0x00D8 (size: 0x1)
...
struct FNiagaraVariableMetaData
{
    ...
    FName ScopeName;                                                                  // 0x00C8 (size: 0x8)
    ENiagaraScriptParameterUsage Usage;                                               // 0x00D0 (size: 0x4)
    bool bIsStaticSwitch;                                                             // 0x00D4 (size: 0x1)
    int32 StaticSwitchDefaultValue;                                                   // 0x00D8 (size: 0x4)
    bool bAddedToNodeGraphDeepCopy;                                                   // 0x00DC (size: 0x1)
    bool bOutputIsPersistent;                                                         // 0x00DD (size: 0x1)
    FName CachedNamespacelessVariableName;                                            // 0x00E0 (size: 0x8)
    bool bCreatedInSystemEditor;                                                      // 0x00E8 (size: 0x1)
    bool bUseLegacyNameString;                                                        // 0x00E9 (size: 0x1)
...
{
    FNiagaraVariable Parameter;                                                       // 0x0088 (size: 0x20)
...
{
    int32 ChannelsUsed;                                                               // 0x00B0 (size: 0x4)

}; // Size: 0xB8

class UNiagaraComponent : public UFXSystemComponent
{
    class UNiagaraSystem* Asset;                                                      // 0x0440 (size: 0x8)
    ENiagaraTickBehavior TickBehavior;                                                // 0x0448 (size: 0x1)
    FNiagaraUserRedirectionParameterStore OverrideParameters;                         // 0x0450 (size: 0xC8)
    uint8 bForceSolo;                                                                 // 0x0518 (size: 0x1)
    uint8 bEnableGpuComputeDebug;                                                     // 0x0518 (size: 0x1)
    uint8 bAutoDestroy;                                                               // 0x0544 (size: 0x1)
    uint8 bRenderingEnabled;                                                          // 0x0544 (size: 0x1)
    uint8 bAutoManageAttachment;                                                      // 0x0544 (size: 0x1)
    uint8 bAutoAttachWeldSimulatedBodies;                                             // 0x0544 (size: 0x1)
    float MaxTimeBeforeForceUpdateTransform;                                          // 0x0548 (size: 0x4)
    TArray<FNiagaraMaterialOverride> EmitterMaterials;                                // 0x0550 (size: 0x10)
    FNiagaraComponentOnSystemFinished OnSystemFinished;                               // 0x0568 (size: 0x10)
    void OnNiagaraSystemFinished(class UNiagaraComponent* PSystem);
    TWeakObjectPtr<class USceneComponent> AutoAttachParent;                           // 0x0578 (size: 0x8)
    FName AutoAttachSocketName;                                                       // 0x0580 (size: 0x8)
    EAttachmentRule AutoAttachLocationRule;                                           // 0x0588 (size: 0x1)
    EAttachmentRule AutoAttachRotationRule;                                           // 0x0589 (size: 0x1)
    EAttachmentRule AutoAttachScaleRule;                                              // 0x058A (size: 0x1)
...
{
    TSubclassOf<class USceneComponent> ComponentType;                                 // 0x0080 (size: 0x8)
    uint32 ComponentCountLimit;                                                       // 0x0088 (size: 0x4)
    FNiagaraVariableAttributeBinding EnabledBinding;                                  // 0x0090 (size: 0x58)
    bool bAssignComponentsOnParticleID;                                               // 0x00E8 (size: 0x1)
    bool bOnlyCreateComponentsOnParticleSpawn;                                        // 0x00E9 (size: 0x1)
    class USceneComponent* TemplateComponent;                                         // 0x00F0 (size: 0x8)
    TArray<FNiagaraComponentPropertyBinding> PropertyBindings;                        // 0x00F8 (size: 0x10)
...
class UNiagaraDataInterfaceGrid3DCollection : public UNiagaraDataInterfaceGrid3D
{
    ...
    ENiagaraGpuBufferFormat BufferFormat;                                             // 0x0128 (size: 0x1)
...
class UNiagaraDataInterfaceRenderTarget2D : public UNiagaraDataInterfaceRWBase
{
    ...
    TEnumAsByte<ETextureRenderTargetFormat> OverrideRenderTargetFormat;               // 0x00E0 (size: 0x1)
    uint8 bOverrideFormat;                                                            // 0x00E1 (size: 0x1)
    FNiagaraUserParameterBinding RenderTargetUserParameter;                           // 0x00E8 (size: 0x20)
    TMap<uint64, UTextureRenderTarget2D*> ManagedRenderTargets;                       // 0x0108 (size: 0x50)
...
class UNiagaraDataInterfaceSkeletalMesh : public UNiagaraDataInterface
{
    ...
    bool bRequireCurrentFrameData;                                                    // 0x00B9 (size: 0x1)
...
{
    uint8 bUseInverseSquaredFalloff;                                                  // 0x0080 (size: 0x1)
    uint8 bAffectsTranslucency;                                                       // 0x0080 (size: 0x1)
    float RadiusScale;                                                                // 0x0084 (size: 0x4)
    FVector ColorAdd;                                                                 // 0x0088 (size: 0xC)
...
{
    class UStaticMesh* ParticleMesh;                                                  // 0x0080 (size: 0x8)
    ENiagaraSortMode SortMode;                                                        // 0x0088 (size: 0x1)
    ...
    uint8 bSubImageBlend;                                                             // 0x00A8 (size: 0x1)
    ENiagaraMeshFacingMode FacingMode;                                                // 0x00AC (size: 0x1)
    uint8 bLockedAxisEnable;                                                          // 0x00B0 (size: 0x1)
    FVector LockedAxis;                                                               // 0x00B4 (size: 0xC)
    ENiagaraMeshLockedAxisSpace LockedAxisSpace;                                      // 0x00C0 (size: 0x1)
    FVector PivotOffset;                                                              // 0x00C4 (size: 0xC)
    ENiagaraMeshPivotOffsetSpace PivotOffsetSpace;                                    // 0x00D0 (size: 0x1)
    uint8 bEnableFrustumCulling;                                                      // 0x00D4 (size: 0x1)
    uint8 bEnableCameraDistanceCulling;                                               // 0x00D4 (size: 0x1)
    float MinCameraDistance;                                                          // 0x00D8 (size: 0x4)
    float MaxCameraDistance;                                                          // 0x00DC (size: 0x4)
    uint32 RendererVisibility;                                                        // 0x00E0 (size: 0x4)
    FNiagaraVariableAttributeBinding PositionBinding;                                 // 0x00E8 (size: 0x58)
    FNiagaraVariableAttributeBinding ColorBinding;                                    // 0x0140 (size: 0x58)
    FNiagaraVariableAttributeBinding VelocityBinding;                                 // 0x0198 (size: 0x58)
    FNiagaraVariableAttributeBinding MeshOrientationBinding;                          // 0x01F0 (size: 0x58)
    FNiagaraVariableAttributeBinding ScaleBinding;                                    // 0x0248 (size: 0x58)
    FNiagaraVariableAttributeBinding SubImageIndexBinding;                            // 0x02A0 (size: 0x58)
    FNiagaraVariableAttributeBinding DynamicMaterialBinding;                          // 0x02F8 (size: 0x58)
    FNiagaraVariableAttributeBinding DynamicMaterial1Binding;                         // 0x0350 (size: 0x58)
    FNiagaraVariableAttributeBinding DynamicMaterial2Binding;                         // 0x03A8 (size: 0x58)
    FNiagaraVariableAttributeBinding DynamicMaterial3Binding;                         // 0x0400 (size: 0x58)
    FNiagaraVariableAttributeBinding MaterialRandomBinding;                           // 0x0458 (size: 0x58)
    FNiagaraVariableAttributeBinding CustomSortingBinding;                            // 0x04B0 (size: 0x58)
    FNiagaraVariableAttributeBinding NormalizedAgeBinding;                            // 0x0508 (size: 0x58)
    FNiagaraVariableAttributeBinding CameraOffsetBinding;                             // 0x0560 (size: 0x58)
    FNiagaraVariableAttributeBinding RendererVisibilityTagBinding;                    // 0x05B8 (size: 0x58)
...
class UNiagaraRendererProperties : public UNiagaraMergeable
{
    ...
    bool bIsEnabled;                                                                  // 0x005C (size: 0x1)
    bool bMotionBlurEnabled;                                                          // 0x005D (size: 0x1)

}; // Size: 0x80

class UNiagaraRibbonRendererProperties : public UNiagaraRendererProperties
{
    class UMaterialInterface* Material;                                               // 0x0080 (size: 0x8)
    FNiagaraUserParameterBinding MaterialUserParamBinding;                            // 0x0088 (size: 0x20)
    ENiagaraRibbonFacingMode FacingMode;                                              // 0x00A8 (size: 0x1)
    FNiagaraRibbonUVSettings UV0Settings;                                             // 0x00AC (size: 0x24)
    FNiagaraRibbonUVSettings UV1Settings;                                             // 0x00D0 (size: 0x24)
    ENiagaraRibbonDrawDirection DrawDirection;                                        // 0x00F4 (size: 0x1)
    float CurveTension;                                                               // 0x00F8 (size: 0x4)
    ENiagaraRibbonTessellationMode TessellationMode;                                  // 0x00FC (size: 0x1)
    int32 TessellationFactor;                                                         // 0x0100 (size: 0x4)
    bool bUseConstantFactor;                                                          // 0x0104 (size: 0x1)
    float TessellationAngle;                                                          // 0x0108 (size: 0x4)
    bool bScreenSpaceTessellation;                                                    // 0x010C (size: 0x1)
    FNiagaraVariableAttributeBinding PositionBinding;                                 // 0x0110 (size: 0x58)
    FNiagaraVariableAttributeBinding ColorBinding;                                    // 0x0168 (size: 0x58)
    FNiagaraVariableAttributeBinding VelocityBinding;                                 // 0x01C0 (size: 0x58)
    FNiagaraVariableAttributeBinding NormalizedAgeBinding;                            // 0x0218 (size: 0x58)
    FNiagaraVariableAttributeBinding RibbonTwistBinding;                              // 0x0270 (size: 0x58)
    FNiagaraVariableAttributeBinding RibbonWidthBinding;                              // 0x02C8 (size: 0x58)
    FNiagaraVariableAttributeBinding RibbonFacingBinding;                             // 0x0320 (size: 0x58)
    FNiagaraVariableAttributeBinding RibbonIdBinding;                                 // 0x0378 (size: 0x58)
    FNiagaraVariableAttributeBinding RibbonLinkOrderBinding;                          // 0x03D0 (size: 0x58)
    FNiagaraVariableAttributeBinding MaterialRandomBinding;                           // 0x0428 (size: 0x58)
    FNiagaraVariableAttributeBinding DynamicMaterialBinding;                          // 0x0480 (size: 0x58)
    FNiagaraVariableAttributeBinding DynamicMaterial1Binding;                         // 0x04D8 (size: 0x58)
    FNiagaraVariableAttributeBinding DynamicMaterial2Binding;                         // 0x0530 (size: 0x58)
    FNiagaraVariableAttributeBinding DynamicMaterial3Binding;                         // 0x0588 (size: 0x58)
    FNiagaraVariableAttributeBinding U0OverrideBinding;                               // 0x05E0 (size: 0x58)
    FNiagaraVariableAttributeBinding V0RangeOverrideBinding;                          // 0x0638 (size: 0x58)
    FNiagaraVariableAttributeBinding U1OverrideBinding;                               // 0x0690 (size: 0x58)
    FNiagaraVariableAttributeBinding V1RangeOverrideBinding;                          // 0x06E8 (size: 0x58)
...
class UNiagaraScript : public UNiagaraScriptBase
{
    ...
    FNiagaraVMExecutableDataId CachedScriptVMId;                                      // 0x0160 (size: 0x48)
    FNiagaraVMExecutableData CachedScriptVM;                                          // 0x01B8 (size: 0xE0)
    TArray<class UNiagaraParameterCollection*> CachedParameterCollectionReferences;   // 0x0298 (size: 0x10)
    TArray<FNiagaraScriptDataInterfaceInfo> CachedDefaultDataInterfaces;              // 0x02A8 (size: 0x10)
...
class UNiagaraSettings : public UDeveloperSettings
{
    ...
    class UNiagaraEffectType* DefaultEffectTypePtr;                                   // 0x00B8 (size: 0x8)
...
class UNiagaraSpriteRendererProperties : public UNiagaraRendererProperties
{
    ...
    FNiagaraUserParameterBinding MaterialUserParamBinding;                            // 0x0090 (size: 0x20)
    ENiagaraSpriteAlignment Alignment;                                                // 0x00B0 (size: 0x1)
    ENiagaraSpriteFacingMode FacingMode;                                              // 0x00B1 (size: 0x1)
    FVector2D PivotInUVSpace;                                                         // 0x00B4 (size: 0x8)
    ENiagaraSortMode SortMode;                                                        // 0x00BC (size: 0x1)
    FVector2D SubImageSize;                                                           // 0x00C0 (size: 0x8)
    uint8 bSubImageBlend;                                                             // 0x00C8 (size: 0x1)
    uint8 bRemoveHMDRollInVR;                                                         // 0x00C8 (size: 0x1)
    uint8 bSortOnlyWhenTranslucent;                                                   // 0x00C8 (size: 0x1)
    uint8 bGpuLowLatencyTranslucency;                                                 // 0x00C8 (size: 0x1)
    float MinFacingCameraBlendDistance;                                               // 0x00CC (size: 0x4)
    float MaxFacingCameraBlendDistance;                                               // 0x00D0 (size: 0x4)
    uint8 bEnableCameraDistanceCulling;                                               // 0x00D4 (size: 0x1)
    float MinCameraDistance;                                                          // 0x00D8 (size: 0x4)
    float MaxCameraDistance;                                                          // 0x00DC (size: 0x4)
    uint32 RendererVisibility;                                                        // 0x00E0 (size: 0x4)
    ...
    FNiagaraVariableAttributeBinding ColorBinding;                                    // 0x0140 (size: 0x58)
    FNiagaraVariableAttributeBinding VelocityBinding;                                 // 0x0198 (size: 0x58)
    FNiagaraVariableAttributeBinding SpriteRotationBinding;                           // 0x01F0 (size: 0x58)
    FNiagaraVariableAttributeBinding SpriteSizeBinding;                               // 0x0248 (size: 0x58)
    FNiagaraVariableAttributeBinding SpriteFacingBinding;                             // 0x02A0 (size: 0x58)
    FNiagaraVariableAttributeBinding SpriteAlignmentBinding;                          // 0x02F8 (size: 0x58)
    FNiagaraVariableAttributeBinding SubImageIndexBinding;                            // 0x0350 (size: 0x58)
    FNiagaraVariableAttributeBinding DynamicMaterialBinding;                          // 0x03A8 (size: 0x58)
    FNiagaraVariableAttributeBinding DynamicMaterial1Binding;                         // 0x0400 (size: 0x58)
    FNiagaraVariableAttributeBinding DynamicMaterial2Binding;                         // 0x0458 (size: 0x58)
    FNiagaraVariableAttributeBinding DynamicMaterial3Binding;                         // 0x04B0 (size: 0x58)
    FNiagaraVariableAttributeBinding CameraOffsetBinding;                             // 0x0508 (size: 0x58)
    FNiagaraVariableAttributeBinding UVScaleBinding;                                  // 0x0560 (size: 0x58)
    FNiagaraVariableAttributeBinding MaterialRandomBinding;                           // 0x05B8 (size: 0x58)
    FNiagaraVariableAttributeBinding CustomSortingBinding;                            // 0x0610 (size: 0x58)
    FNiagaraVariableAttributeBinding NormalizedAgeBinding;                            // 0x0668 (size: 0x58)
    FNiagaraVariableAttributeBinding RendererVisibilityTagBinding;                    // 0x06C0 (size: 0x58)
    TArray<FNiagaraMaterialAttributeBinding> MaterialParameterBindings;               // 0x0718 (size: 0x10)
...
class UNiagaraSystem : public UFXSystemAsset
{
    ...
    bool bRequireCurrentFrameData;                                                    // 0x0032 (size: 0x1)
