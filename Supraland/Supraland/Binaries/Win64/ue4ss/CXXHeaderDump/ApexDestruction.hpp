...
{
    class UDestructibleComponent* DestructibleComponent;                              // 0x0220 (size: 0x8)
    FDestructibleActorOnActorFracture OnActorFracture;                                // 0x0228 (size: 0x10)
...
{
    uint8 bFractureEffectOverride;                                                    // 0x0690 (size: 0x1)
    TArray<FFractureEffect> FractureEffects;                                          // 0x0698 (size: 0x10)
    bool bEnableHardSleeping;                                                         // 0x06A8 (size: 0x1)
    float LargeChunkThreshold;                                                        // 0x06AC (size: 0x4)
    FDestructibleComponentOnComponentFracture OnComponentFracture;                    // 0x06C0 (size: 0x10)
