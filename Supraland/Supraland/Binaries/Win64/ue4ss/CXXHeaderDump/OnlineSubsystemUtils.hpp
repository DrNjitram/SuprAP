...
{
    float SocketErrorDisconnectDelay;                                                 // 0x1B40 (size: 0x4)

}; // Size: 0x1B90

class UIpNetDriver : public UNetDriver
{
    uint8 LogPortUnreach;                                                             // 0x0748 (size: 0x1)
    uint8 AllowPlayerPortUnreach;                                                     // 0x0748 (size: 0x1)
    uint32 MaxPortCountToTry;                                                         // 0x074C (size: 0x4)
    uint32 ServerDesiredSocketReceiveBufferBytes;                                     // 0x075C (size: 0x4)
    uint32 ServerDesiredSocketSendBufferBytes;                                        // 0x0760 (size: 0x4)
    uint32 ClientDesiredSocketReceiveBufferBytes;                                     // 0x0764 (size: 0x4)
    uint32 ClientDesiredSocketSendBufferBytes;                                        // 0x0768 (size: 0x4)
    double MaxSecondsInReceive;                                                       // 0x0770 (size: 0x8)
    int32 NbPacketsBetweenReceiveTimeTest;                                            // 0x0778 (size: 0x4)
    float ResolutionConnectionTimeout;                                                // 0x077C (size: 0x4)
