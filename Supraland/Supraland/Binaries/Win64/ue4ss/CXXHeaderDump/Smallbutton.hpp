#ifndef UE4SS_SDK_Smallbutton_HPP
#define UE4SS_SDK_Smallbutton_HPP

class ASmallbutton_C : public AActor
{
    ...
    float Timeline_0_Button_Down_0391F6FF437E122E2E94609542241F5E;                    // 0x0270 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline_0__Direction_0391F6FF437E122E2E94609542241F5E; // 0x0274 (size: 0x1)
    class UTimelineComponent* Timeline_0;                                             // 0x0278 (size: 0x8)
    FSmallbutton_CButton Status Button Status;                                        // 0x0280 (size: 0x10)
    void Button Status();
    bool button pressed;                                                              // 0x0290 (size: 0x1)
    class AActor* Actor;                                                              // 0x0298 (size: 0x8)
    bool OpenForever;                                                                 // 0x02A0 (size: 0x1)
    float ButtonreturnDelay;                                                          // 0x02A4 (size: 0x4)
    ...
    void SaveAndDestroy();
    void ExecuteUbergraph_Smallbutton(int32 EntryPoint);
