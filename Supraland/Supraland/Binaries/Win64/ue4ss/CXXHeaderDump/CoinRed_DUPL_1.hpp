#ifndef UE4SS_SDK_CoinRed_DUPL_1_HPP
#define UE4SS_SDK_CoinRed_DUPL_1_HPP

class ACoinRed_C : public AActor
{
    ...
    FVector Timeline_1_Move_up_756FEEC846F95A475E1D548999E148A7;                      // 0x0258 (size: 0xC)
    TEnumAsByte<ETimelineDirection::Type> Timeline_1__Direction_756FEEC846F95A475E1D548999E148A7; // 0x0264 (size: 0x1)
    class UTimelineComponent* Timeline_1;                                             // 0x0268 (size: 0x8)
    float Timeline_0_Scale_7893445046BB2D9E105BF4BD8550CEE0;                          // 0x0270 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline_0__Direction_7893445046BB2D9E105BF4BD8550CEE0; // 0x0274 (size: 0x1)
    ...
    void ExecuteUbergraph_CoinRed(int32 EntryPoint);
}; // Size: 0x288
