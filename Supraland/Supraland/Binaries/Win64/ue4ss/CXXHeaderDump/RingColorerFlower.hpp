#ifndef UE4SS_SDK_RingColorerFlower_HPP
#define UE4SS_SDK_RingColorerFlower_HPP

class ARingColorerFlower_C : public AActor
{
    ...
    void Open2();
    void ExecuteUbergraph_RingColorerFlower(int32 EntryPoint);
}; // Size: 0x248
